		...
		<?php
			...
			while ($file = readdir($directory)) {
				if ($file!='..' and $file!='.' and (substr($file,-4)==".gif" or substr($file,-4)==".jpg" or substr($file,-4)==".png")){
					echo "<div style=\"display:inline-block; text-align: center; font-size: 0.8em;\"><img style=\"width: 90px; height: 90px; margin: 5px; cursor: pointer;\" src=\"images/$file\" alt=\"$file\" title=\"$file\" onclick=\"selectImage('$file')\" /><br/><a href=\"images/$file\" target=\"_blank\">See Full Image</a></div></div>";
				}
			}
		?>
...
<?php
	...
	print("<script src=\"EJ_adverts.js\" language=\"javascript\" type=\"text/javascript\" onload=\"updateimage('".$_POST['imagefind']."');\"></script>");
	print("Image Updated!");
}
?>
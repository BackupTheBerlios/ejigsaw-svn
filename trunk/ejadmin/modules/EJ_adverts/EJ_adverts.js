...
function saveadvert(key, id)
{
	...
	if (empty(form.address1.value))
	{
		message = message + "<p class=\"EJ_user_error\" style=\"text-align: left;\">'Address' line 1 cannot be empty!</p>";
	}
	if (empty(form.address2.value))
	{
		message = message + "<p class=\"EJ_user_error\" style=\"text-align: left;\">'Address' line 2 cannot be empty!</p>";
	}
	...
	} else
	{
		...
		ajax.send("title="+escape(title)+"&desc="+escape(desc)+"&cat="+cat+"&date="+date+"&poster="+poster+"&hidden="+hidden+"&address1="+address1+"&address2="+address2+"&address3="+address3+"&address4="+address4+"&address5="+address5+"&phone="+phone+"&contact="+contact+"&website="+website+"&image="+image+"&locs="+locs+"&atts="+atts+sendid+"&key="+key);
	}
}
...
function saveadvertprofile(key, id)
{
	...
	} else
	{
		...
		ajax.send("title="+escape(title)+"&desc="+escape(desc)+"&cat="+cat+"&address1="+address1+"&address2="+address2+"&address3="+address3+"&address4="+address4+"&address5="+address5+"&phone="+phone+"&contact="+contact+"&website="+website+"&image="+image+"&locs="+locs+"&atts="+atts+"&id="+id+"&key="+key);
	}
}
...
function changepic() {
    if ( !document.getElementById("picoverlay") ) {
        ...
        picframe.innerHTML = "<div style=\"text-align:right; height: 15px; cursor:pointer;\">CLOSE</div><iframe src =\"modules/EJ_adverts/changepic.php\" style=\"border:0; height: 285px; width: 500px;\"><p>Your browser does not support iframes.</p></iframe>";
...
function updateimage(img) {
	parent.document.getElementById('advertimage').src = "modules/EJ_adverts/images/"+img;
	if (img != 'noimage.png')
	{
